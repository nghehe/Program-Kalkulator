...
root = Tk();
root.title('My Projek Kalkulator');
root.geometry('380x300+200+250');
Titlelabel = Label(root, fg = 'green' , font = 'none 10 bold underline' ,text = 'HITUNG DISINI', compound = CENTER)
...
Numberentry2.place(relx=0.5, rely=0.3
                   , anchor='center')
...
mulbutton.place(relx=0.7, rely=0.7)

divbutton = Button(root, text=":", width = 5, command = actionDiv);
divbutton.place(relx=0.5, rely=0.7)
